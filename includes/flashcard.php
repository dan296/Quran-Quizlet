...
<i id="surah-audio" class="fas fa-play-circle ayah-audio"></i>
    ...
    outline: none;
    cursor: pointer;
"><option value="0">Al-Faatiha</option><option value="1">Al-Baqara</option><option value="2">Aal-i-Imraan</option><option value="3">An-Nisaa</option><option value="4">Al-Maaida</option><option value="5">Al-An'aam</option><option value="6">Al-A'raaf</option><option value="7">Al-Anfaal</option><option value="8">At-Tawba</option><option value="9">Yunus</option><option value="10">Hud</option><option value="11">Yusuf</option><option value="12">Ar-Ra'd</option><option value="13">Ibrahim</option><option value="14">Al-Hijr</option><option value="15">An-Nahl</option><option value="16">Al-Israa</option><option value="17">Al-Kahf</option><option value="18">Maryam</option><option value="19">Taa-Haa</option><option value="20">Al-Anbiyaa</option><option value="21">Al-Hajj</option><option value="22">Al-Muminoon</option><option value="23">An-Noor</option><option value="24">Al-Furqaan</option><option value="25">Ash-Shu'araa</option><option value="26">An-Naml</option><option value="27">Al-Qasas</option><option value="28">Al-Ankaboot</option><option value="29">Ar-Room</option><option value="30">Luqman</option><option value="31">As-Sajda</option><option value="32">Al-Ahzaab</option><option value="33">Saba</option><option value="34">Faatir</option><option value="35">Yaseen</option><option value="36">As-Saaffaat</option><option value="37">Saad</option><option value="38">Az-Zumar</option><option value="39">Ghafir</option><option value="40">Fussilat</option><option value="41">Ash-Shura</option><option value="42">Az-Zukhruf</option><option value="43">Ad-Dukhaan</option><option value="44">Al-Jaathiya</option><option value="45">Al-Ahqaf</option><option value="46">Muhammad</option><option value="47">Al-Fath</option><option value="48">Al-Hujuraat</option><option value="49">Qaaf</option><option value="50">Adh-Dhaariyat</option><option value="51">At-Tur</option><option value="52">An-Najm</option><option value="53">Al-Qamar</option><option value="54">Ar-Rahmaan</option><option value="55">Al-Waaqia</option><option value="56">Al-Hadid</option><option value="57">Al-Mujaadila</option><option value="58">Al-Hashr</option><option value="59">Al-Mumtahana</option><option value="60">As-Saff</option><option value="61">Al-Jumu'a</option><option value="62">Al-Munaafiqoon</option><option value="63">At-Taghaabun</option><option value="64">At-Talaaq</option><option value="65">At-Tahrim</option><option value="66">Al-Mulk</option><option value="67">Al-Qalam</option><option value="68">Al-Haaqqa</option><option value="69">Al-Ma'aarij</option><option value="70">Nooh</option><option value="71">Al-Jinn</option><option value="72">Al-Muzzammil</option><option value="73">Al-Muddaththir</option><option value="74">Al-Qiyaama</option><option value="75">Al-Insaan</option><option value="76">Al-Mursalaat</option><option value="77">An-Naba</option><option value="78">An-Naazi'aat</option><option value="79">Abasa</option><option value="80">At-Takwir</option><option value="81">Al-Infitaar</option><option value="82">Al-Mutaffifin</option><option value="83">Al-Inshiqaaq</option><option value="84">Al-Burooj</option><option value="85">At-Taariq</option><option value="86">Al-A'laa</option><option value="87">Al-Ghaashiya</option><option value="88">Al-Fajr</option><option value="89">Al-Balad</option><option value="90">Ash-Shams</option><option value="91">Al-Lail</option><option value="92">Ad-Dhuhaa</option><option value="93">Ash-Sharh</option><option value="94">At-Tin</option><option value="95">Al-Alaq</option><option value="96">Al-Qadr</option><option value="97">Al-Bayyina</option><option value="98">Az-Zalzala</option><option value="99">Al-Aadiyaat</option><option value="100">Al-Qaari'a</option><option value="101">At-Takaathur</option><option value="102">Al-Asr</option><option value="103">Al-Humaza</option><option value="104">Al-Fil</option><option value="105">Quraish</option><option value="106">Al-Maa'un</option><option value="107">Al-Kawthar</option><option value="108">Al-Kaafiroon</option><option value="109">An-Nasr</option><option value="110">Al-Masad</option><option value="111">Al-Ikhlaas</option><option value="112">Al-Falaq</option><option value="113">An-Naas</option></select>
